...
import com.retired64.termux.shared.reflection.ReflectionUtils;
...
import com.retired64.termux.shared.termux.TermuxConstants.TERMUX_APP;
...
public class TermuxUtils {
     ...
     *
     * If your third-party app is targeting sdk `30` (android `11`), then it needs to add `com.retired64.termux`
     * package to the `queries` element or request `QUERY_ALL_PACKAGES` permission in its
     * `AndroidManifest.xml`. Otherwise it will get `PackageSetting{...... com.retired64.termux/......} BLOCKED`
     ...
     * <manifest
     *     <queries>
     *         <package android:name="com.retired64.termux" />
     *    </queries>
     * </manifest>
     * }
     *
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.retired64.termux.shared.R.raw.apt_info_script);
        try {
