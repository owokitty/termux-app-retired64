package com.retired64.termux.shared.activities;
...
import com.retired64.termux.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.retired64.termux.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.retired64.termux.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
