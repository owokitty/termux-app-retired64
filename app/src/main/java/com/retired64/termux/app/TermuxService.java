...
import com.retired64.termux.app.event.SystemEventReceiver;
import com.retired64.termux.app.terminal.TermuxTerminalSessionActivityClient;
import com.retired64.termux.app.terminal.TermuxTerminalSessionServiceClient;
import com.retired64.termux.shared.termux.plugins.TermuxPluginUtils;
import com.retired64.termux.shared.data.IntentUtils;
import com.retired64.termux.shared.net.uri.UriUtils;
import com.retired64.termux.shared.errors.Errno;
import com.retired64.termux.shared.shell.ShellUtils;
import com.retired64.termux.shared.shell.command.runner.app.AppShell;
...
import com.retired64.termux.shared.termux.shell.TermuxShellUtils;
...
import com.retired64.termux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.retired64.termux.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.retired64.termux.shared.termux.shell.TermuxShellManager;
...
import com.retired64.termux.shared.notification.NotificationUtils;
...
import com.retired64.termux.shared.shell.command.ExecutionCommand.ShellCreateMode;
import com.retired64.termux.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.retired64.termux.shared.R.string.error_execution_cancelled))) {
