...
import com.retired64.termux.shared.termux.terminal.io.BellHandler;
import com.retired64.termux.shared.logger.Logger;
import com.retired64.termux.terminal.TerminalColors;
import com.retired64.termux.terminal.TerminalSession;
import com.retired64.termux.terminal.TerminalSessionClient;
import com.retired64.termux.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.retired64.termux/com.retired64.termux.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
